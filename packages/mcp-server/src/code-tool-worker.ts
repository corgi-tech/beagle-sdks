...
import { Beagle, ClientOptions } from '@corgi-tech/beagle';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Beagle)`
    : `const run: (${functionSource.client}: Beagle) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.propertyManagers.create',
    'client.propertyManagers.delete',
    'client.propertyManagers.list',
    'client.propertyManagers.retrieve',
    'client.propertyManagers.update',
    'client.tenants.create',
    'client.tenants.delete',
    'client.tenants.list',
    'client.tenants.retrieve',
