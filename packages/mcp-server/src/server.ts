...
import { ClientOptions } from 'beagle';
...
export { ClientOptions } from 'beagle';
...
export function initMcpServer(params: {
  ...
  const client = new Beagle(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Beagle({ environment: (readEnv('BEAGLE_ENVIRONMENT') || undefined) as any });
