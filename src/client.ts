...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['BEAGLE_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['BEAGLE_LOG'] or 'warn' if it isn't set.
   */
...
export class Beagle {
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('BEAGLE_LOG'), "process.env['BEAGLE_LOG']", this) ??
      defaultLogLevel;
  ...
  static BeagleError = Errors.BeagleError;
